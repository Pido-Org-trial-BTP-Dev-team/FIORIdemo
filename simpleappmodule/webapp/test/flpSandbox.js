		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#simpleappmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"simpleappmodule-display": {
								"semanticObject": "simpleappmodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=simpleappmodule",
									"url": sap.ui.require.toUrl("simpleappmodule")
								}
							}
						}
					}
